...
private:
    ...
    bool mIsCollidingWithTarget = false;
...
public:
    ...
    bool isCollidingWithTarget() const { return mIsCollidingWithTarget; }
    ...
    void setFlyingPower(float newFlyingPower)
        { mFlyingPower = newFlyingPower; }
