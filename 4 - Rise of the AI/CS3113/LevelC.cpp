...
void LevelC::initialise()
{
   ...
   */
   ...
   mGameState.enemies[0].init(
      {mOrigin.x + 1000.0f, mOrigin.y + 100.0f},
   ...
   mGameState.enemies[0].setSpeed(130.0f);
   ...
   mGameState.enemies[1].init(
      ...
      "assets/game/ufeff_tiles_v2.png",
      ATLAS, { 16, 16 }, lerperAnimationAtlas, NPC
   );
   mGameState.enemies[1].setAIType(LERPER);
   mGameState.enemies[1].setSpeed(50.0f);
...
void LevelC::update(float deltaTime)
{
   ...
   if (mGameState.soldier->getPosition().x > 2000.0f && mGameState.soldier->getPosition().y > 500.0f) mGameState.nextSceneID = 4;
